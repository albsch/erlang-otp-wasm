$(EBIN)/dtls_server_connection.$(EMULATOR): dtls_server_connection.erl dtls_connection.hrl \
...
$(EBIN)/dtls_client_connection.$(EMULATOR): dtls_client_connection.erl dtls_connection.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl \
  ../../public_key/include/public_key.hrl \
  ssl_record.hrl ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl \
...
$(EBIN)/dtls_gen_connection.$(EMULATOR): dtls_gen_connection.erl dtls_connection.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl \
  ../../public_key/include/public_key.hrl \
  ssl_record.hrl ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl \
...
$(EBIN)/inet_epmd_tls_socket.$(EMULATOR): inet_epmd_tls_socket.erl \
...
$(EBIN)/tls_dtls_client_connection.$(EMULATOR): tls_dtls_client_connection.erl \
  ../../public_key/include/public_key.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl ssl_record.hrl \
  ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl ssl_alert.hrl
$(EBIN)/tls_dtls_server_connection.$(EMULATOR): tls_dtls_server_connection.erl \
  ../../public_key/include/public_key.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl ssl_record.hrl \
  ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl ssl_alert.hrl
$(EBIN)/tls_dtls_gen_connection.$(EMULATOR): tls_dtls_gen_connection.erl \
  ../../public_key/include/public_key.hrl \
  tls_connection.hrl ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl ssl_record.hrl \
  ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl ssl_alert.hrl \
  tls_record.hrl
$(EBIN)/tls_server_connection.$(EMULATOR): tls_server_connection.erl tls_connection.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl \
  ../../public_key/include/public_key.hrl \
  ssl_record.hrl ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl \
  ssl_alert.hrl tls_record.hrl tls_handshake.hrl
$(EBIN)/tls_client_connection.$(EMULATOR): tls_client_connection.erl tls_connection.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl \
  ../../public_key/include/public_key.hrl \
  ssl_record.hrl ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl \
...
$(EBIN)/tls_gen_connection.$(EMULATOR): tls_gen_connection.erl tls_connection.hrl \
  ssl_connection.hrl ssl_internal.hrl \
  ../../kernel/include/logger.hrl \
  ../../public_key/include/public_key.hrl \
  ssl_record.hrl ssl_handshake.hrl ssl_srp.hrl ssl_cipher.hrl ssl_api.hrl \
...
$(EBIN)/tls_socket.$(EMULATOR): tls_socket.erl ssl_internal.hrl \
  ...
  ../../public_key/include/public_key.hrl ssl_api.hrl \
  ssl_record.hrl
$(EBIN)/tls_socket_tcp.$(EMULATOR): tls_socket_tcp.erl

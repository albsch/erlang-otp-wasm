...
%% Purpose: Encoding and decoding of the types in OTP-PKIX-Relaxed.

-module('OTP-PKIX-Relaxed').
-moduledoc false.
-compile(nowarn_unused_vars).
-dialyzer(no_improper_lists).
-dialyzer(no_match).
-include("OTP-PKIX-Relaxed.hrl").
-asn1_info([{vsn,'5.5'},
            {module,'OTP-PKIX-Relaxed'},
...
'enc_OTP-X520name'/2,
'enc_OTP-X520localityName'/2,
'enc_OTP-X520stateOrProvinceName'/2,
'enc_OTP-X520commonName'/2,
'enc_OTP-X520organizationName'/2,
'enc_OTP-X520organizationalUnitName'/2,
'enc_OTP-X520title'/2,
'enc_OTP-X520countryName'/2,
'enc_OTP-X520serialNumber'/2,
'enc_OTP-X520pseudonym'/2,
...
'dec_OTP-X520name'/2,
'dec_OTP-X520localityName'/2,
'dec_OTP-X520stateOrProvinceName'/2,
'dec_OTP-X520commonName'/2,
'dec_OTP-X520organizationName'/2,
'dec_OTP-X520organizationalUnitName'/2,
'dec_OTP-X520title'/2,
'dec_OTP-X520countryName'/2,
'dec_OTP-X520serialNumber'/2,
'dec_OTP-X520pseudonym'/2,
...
-export([
'enc_otp-at-name'/3,
'enc_otp-at-surname'/3,
'enc_otp-at-givenName'/3,
'enc_otp-at-initials'/3,
'enc_otp-at-generationQualifier'/3,
'enc_otp-at-x520LocalityName'/3,
'enc_otp-at-x520StateOrProvinceName'/3,
'enc_otp-at-x520CommonName'/3,
'enc_otp-at-x520OrganizationName'/3,
'enc_otp-at-x520OrganizationalUnitName'/3,
'enc_otp-at-x520Title'/3,
'enc_otp-at-x520countryName'/3,
'enc_otp-at-x520SerialNumber'/3,
'enc_otp-at-x520Pseudonym'/3,
'enc_otp-at-emailAddress'/3
]).

-export([
'dec_otp-at-name'/3,
'dec_otp-at-surname'/3,
'dec_otp-at-givenName'/3,
'dec_otp-at-initials'/3,
'dec_otp-at-generationQualifier'/3,
'dec_otp-at-x520LocalityName'/3,
'dec_otp-at-x520StateOrProvinceName'/3,
'dec_otp-at-x520CommonName'/3,
'dec_otp-at-x520OrganizationName'/3,
'dec_otp-at-x520OrganizationalUnitName'/3,
'dec_otp-at-x520Title'/3,
'dec_otp-at-x520countryName'/3,
'dec_otp-at-x520SerialNumber'/3,
'dec_otp-at-x520Pseudonym'/3,
...
encode_disp('OTP-X520name', Data) -> 'enc_OTP-X520name'(Data);
encode_disp('OTP-X520localityName', Data) -> 'enc_OTP-X520localityName'(Data);
encode_disp('OTP-X520stateOrProvinceName', Data) -> 'enc_OTP-X520stateOrProvinceName'(Data);
encode_disp('OTP-X520commonName', Data) -> 'enc_OTP-X520commonName'(Data);
encode_disp('OTP-X520organizationName', Data) -> 'enc_OTP-X520organizationName'(Data);
encode_disp('OTP-X520organizationalUnitName', Data) -> 'enc_OTP-X520organizationalUnitName'(Data);
encode_disp('OTP-X520title', Data) -> 'enc_OTP-X520title'(Data);
encode_disp('OTP-X520countryName', Data) -> 'enc_OTP-X520countryName'(Data);
encode_disp('OTP-X520serialNumber', Data) -> 'enc_OTP-X520serialNumber'(Data);
encode_disp('OTP-X520pseudonym', Data) -> 'enc_OTP-X520pseudonym'(Data);
...
decode_disp('OTP-X520name', Data) -> 'dec_OTP-X520name'(Data);
decode_disp('OTP-X520localityName', Data) -> 'dec_OTP-X520localityName'(Data);
decode_disp('OTP-X520stateOrProvinceName', Data) -> 'dec_OTP-X520stateOrProvinceName'(Data);
decode_disp('OTP-X520commonName', Data) -> 'dec_OTP-X520commonName'(Data);
decode_disp('OTP-X520organizationName', Data) -> 'dec_OTP-X520organizationName'(Data);
decode_disp('OTP-X520organizationalUnitName', Data) -> 'dec_OTP-X520organizationalUnitName'(Data);
decode_disp('OTP-X520title', Data) -> 'dec_OTP-X520title'(Data);
decode_disp('OTP-X520countryName', Data) -> 'dec_OTP-X520countryName'(Data);
decode_disp('OTP-X520serialNumber', Data) -> 'dec_OTP-X520serialNumber'(Data);
decode_disp('OTP-X520pseudonym', Data) -> 'dec_OTP-X520pseudonym'(Data);
...
%%-------------------------------------------------
%% attribute tbsCertificate(1)   External OTP-PKIX-Relaxed:OTPTBSCertificate
%%-------------------------------------------------
...
Objalgorithm = 
   'OTP-PKIX-Relaxed':'getenc_internal_object_set_argument_9'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'OTP-PKIX-Relaxed':'getdec_internal_object_set_argument_9'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
         try DecObjalgorithmTerm1('Params', Tmpterm1, [])
         catch
            Class1:Reason1 when Class1 =:= error; Class1 =:= exit ->
...
%%-------------------------------------------------
%% attribute issuer(4)   External OTP-PKIX-Relaxed:OTPName
%%-------------------------------------------------
...
%%-------------------------------------------------
%% attribute subject(6)   External OTP-PKIX-Relaxed:OTPName
%%-------------------------------------------------
...
enc_OTPTBSCertificate_signature(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'OTP-PKIX-Relaxed':'getenc_internal_object_set_argument_2'(                                   Cindex1),
...
DecObjalgorithmTerm1 =
   'OTP-PKIX-Relaxed':'getdec_internal_object_set_argument_2'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
enc_OTPRelativeDistinguishedName_SingleAttribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
Objtype = 
   'OTP-PKIX-Relaxed':'getenc_internal_object_set_argument_3'(                                   Cindex1),
...
DecObjtypeTerm1 =
   'OTP-PKIX-Relaxed':'getdec_internal_object_set_argument_3'(Term1),
Term2 = 
   try DecObjtypeTerm1('Type', Tmpterm1, [])
   catch
      Class1:Reason1 when Class1 =:= error; Class1 =:= exit ->
         exit({'Type not compatible with table constraint',Reason1})
   end,
...
%%  OTP-X520name
%%================================
'enc_OTP-X520name'(Val) ->
    'enc_OTP-X520name'(Val, []).

'enc_OTP-X520name'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
...
'dec_OTP-X520name'(Tlv) ->
   'dec_OTP-X520name'(Tlv, []).

'dec_OTP-X520name'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%================================
%%  OTP-X520localityName
%%================================
'enc_OTP-X520localityName'(Val) ->
    'enc_OTP-X520localityName'(Val, []).

'enc_OTP-X520localityName'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520localityName'(Tlv) ->
   'dec_OTP-X520localityName'(Tlv, []).

'dec_OTP-X520localityName'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%================================
%%  OTP-X520stateOrProvinceName
%%================================
'enc_OTP-X520stateOrProvinceName'(Val) ->
    'enc_OTP-X520stateOrProvinceName'(Val, []).

'enc_OTP-X520stateOrProvinceName'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520stateOrProvinceName'(Tlv) ->
   'dec_OTP-X520stateOrProvinceName'(Tlv, []).

'dec_OTP-X520stateOrProvinceName'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%  OTP-X520commonName
%%================================
'enc_OTP-X520commonName'(Val) ->
    'enc_OTP-X520commonName'(Val, []).

'enc_OTP-X520commonName'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520commonName'(Tlv) ->
   'dec_OTP-X520commonName'(Tlv, []).

'dec_OTP-X520commonName'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%================================
%%  OTP-X520organizationName
%%================================
'enc_OTP-X520organizationName'(Val) ->
    'enc_OTP-X520organizationName'(Val, []).

'enc_OTP-X520organizationName'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520organizationName'(Tlv) ->
   'dec_OTP-X520organizationName'(Tlv, []).

'dec_OTP-X520organizationName'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%================================
%%  OTP-X520organizationalUnitName
%%================================
'enc_OTP-X520organizationalUnitName'(Val) ->
    'enc_OTP-X520organizationalUnitName'(Val, []).

'enc_OTP-X520organizationalUnitName'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520organizationalUnitName'(Tlv) ->
   'dec_OTP-X520organizationalUnitName'(Tlv, []).

'dec_OTP-X520organizationalUnitName'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%  OTP-X520title
%%================================
'enc_OTP-X520title'(Val) ->
    'enc_OTP-X520title'(Val, []).

'enc_OTP-X520title'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520title'(Tlv) ->
   'dec_OTP-X520title'(Tlv, []).

'dec_OTP-X520title'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%================================
%%  OTP-X520serialNumber
%%================================
'enc_OTP-X520serialNumber'(Val) ->
    'enc_OTP-X520serialNumber'(Val, []).

'enc_OTP-X520serialNumber'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520serialNumber'(Tlv) ->
   'dec_OTP-X520serialNumber'(Tlv, []).

'dec_OTP-X520serialNumber'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
%%  OTP-X520pseudonym
%%================================
'enc_OTP-X520pseudonym'(Val) ->
    'enc_OTP-X520pseudonym'(Val, []).

'enc_OTP-X520pseudonym'(Val, TagIn) ->
   {EncBytes,EncLen} = case element(1,Val) of
      teletexString ->
         encode_restricted_string(element(2,Val), [<<20>>]);
      printableString ->
...
'dec_OTP-X520pseudonym'(Tlv) ->
   'dec_OTP-X520pseudonym'(Tlv, []).

'dec_OTP-X520pseudonym'(Tlv, TagIn) ->
Tlv1 = match_tags(Tlv, TagIn),
case (case Tlv1 of [CtempTlv1] -> CtempTlv1; _ -> Tlv1 end) of
...
enc_HashSingleAttribute(Val, TagIn) ->
   'OTP-PKIX':enc_HashSingleAttribute(Val, TagIn).
...
'OTP-PKIX':'dec_HashSingleAttribute'(Tlv, TagIn).
...
enc_HashRDNSequence(Val, TagIn) ->
   'OTP-PKIX':enc_HashRDNSequence(Val, TagIn).
...
'OTP-PKIX':'dec_HashRDNSequence'(Tlv, TagIn).
...
enc_HashRelativeDistinguishedName(Val, TagIn) ->
   'OTP-PKIX':enc_HashRelativeDistinguishedName(Val, TagIn).
...
'OTP-PKIX':'dec_HashRelativeDistinguishedName'(Tlv, TagIn).
...
enc_OTPCertificatePolicies(Val, TagIn) ->
   'OTP-PKIX':enc_OTPCertificatePolicies(Val, TagIn).
...
'OTP-PKIX':'dec_OTPCertificatePolicies'(Tlv, TagIn).
...
enc_OTPPolicyInformation(Val, TagIn) ->
   'OTP-PKIX':enc_OTPPolicyInformation(Val, TagIn).
...
'OTP-PKIX':'dec_OTPPolicyInformation'(Tlv, TagIn).
...
enc_OTPPolicyQualifierInfo(Val, TagIn) ->
   'OTP-PKIX':enc_OTPPolicyQualifierInfo(Val, TagIn).
...
'OTP-PKIX':'dec_OTPPolicyQualifierInfo'(Tlv, TagIn).
...
enc_OTPUserNotice(Val, TagIn) ->
   'OTP-PKIX':enc_OTPUserNotice(Val, TagIn).
...
'OTP-PKIX':'dec_OTPUserNotice'(Tlv, TagIn).
...
enc_OTPDisplayText(Val, TagIn) ->
   'OTP-PKIX':enc_OTPDisplayText(Val, TagIn).
...
'OTP-PKIX':'dec_OTPDisplayText'(Tlv, TagIn).
...
enc_Extensions(Val, TagIn) ->
   'OTP-PKIX':enc_Extensions(Val, TagIn).
...
'OTP-PKIX':'dec_Extensions'(Tlv, TagIn).
...
enc_OTPExtension(Val, TagIn) ->
   'OTP-PKIX':enc_OTPExtension(Val, TagIn).
...
'OTP-PKIX':'dec_OTPExtension'(Tlv, TagIn).
...
%%  otp-at-name
%%================================
'enc_otp-at-name'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520name'(Val, []);
'enc_otp-at-name'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-name'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520name'(Tlv, []);
'dec_otp-at-name'('equality-match', _,_) ->
...
%%  otp-at-surname
%%================================
'enc_otp-at-surname'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520name'(Val, []);
'enc_otp-at-surname'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-surname'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520name'(Tlv, []);
'dec_otp-at-surname'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%  otp-at-givenName
%%================================
'enc_otp-at-givenName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520name'(Val, []);
'enc_otp-at-givenName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-givenName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520name'(Tlv, []);
'dec_otp-at-givenName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%  otp-at-initials
%%================================
'enc_otp-at-initials'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520name'(Val, []);
'enc_otp-at-initials'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-initials'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520name'(Tlv, []);
'dec_otp-at-initials'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-generationQualifier
%%================================
'enc_otp-at-generationQualifier'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520name'(Val, []);
'enc_otp-at-generationQualifier'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-generationQualifier'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520name'(Tlv, []);
'dec_otp-at-generationQualifier'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520LocalityName
%%================================
'enc_otp-at-x520LocalityName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520localityName'(Val, []);
'enc_otp-at-x520LocalityName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520LocalityName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520localityName'(Tlv, []);
'dec_otp-at-x520LocalityName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520StateOrProvinceName
%%================================
'enc_otp-at-x520StateOrProvinceName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520stateOrProvinceName'(Val, []);
'enc_otp-at-x520StateOrProvinceName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520StateOrProvinceName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520stateOrProvinceName'(Tlv, []);
'dec_otp-at-x520StateOrProvinceName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520CommonName
%%================================
'enc_otp-at-x520CommonName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520commonName'(Val, []);
'enc_otp-at-x520CommonName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520CommonName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520commonName'(Tlv, []);
'dec_otp-at-x520CommonName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520OrganizationName
%%================================
'enc_otp-at-x520OrganizationName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520organizationName'(Val, []);
'enc_otp-at-x520OrganizationName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520OrganizationName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520organizationName'(Tlv, []);
'dec_otp-at-x520OrganizationName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520OrganizationalUnitName
%%================================
'enc_otp-at-x520OrganizationalUnitName'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520organizationalUnitName'(Val, []);
'enc_otp-at-x520OrganizationalUnitName'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520OrganizationalUnitName'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520organizationalUnitName'(Tlv, []);
'dec_otp-at-x520OrganizationalUnitName'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%  otp-at-x520Title
%%================================
'enc_otp-at-x520Title'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520title'(Val, []);
'enc_otp-at-x520Title'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520Title'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520title'(Tlv, []);
'dec_otp-at-x520Title'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520SerialNumber
%%================================
'enc_otp-at-x520SerialNumber'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520serialNumber'(Val, []);
'enc_otp-at-x520SerialNumber'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520SerialNumber'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520serialNumber'(Tlv, []);
'dec_otp-at-x520SerialNumber'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
%%================================
%%  otp-at-x520Pseudonym
%%================================
'enc_otp-at-x520Pseudonym'('Type', Val, _RestPrimFieldName) ->
   'enc_OTP-X520pseudonym'(Val, []);
'enc_otp-at-x520Pseudonym'('equality-match', _,_) ->
  exit({error,{'use of missing field in object', 'equality-match'}}).


'dec_otp-at-x520Pseudonym'('Type', Bytes,_) ->
  Tlv = tlv_format(Bytes),
   'dec_OTP-X520pseudonym'(Tlv, []);
'dec_otp-at-x520Pseudonym'('equality-match', _,_) ->
  exit({error,{'illegal use of missing field in object', 'equality-match'}}).
...
getenc_OTPSupportedAttributes(Id) when Id =:= {2,5,4,65} ->
    fun 'enc_otp-at-x520Pseudonym'/3;
...
getdec_OTPSupportedAttributes(Id) when Id =:= {2,5,4,65} ->
    fun 'dec_otp-at-x520Pseudonym'/3;
...
getenc_internal_object_set_argument_9(Id) when Id =:= {1,2,840,10040,4,3} ->
   fun(T,V,O) -> 'OTP-PKIX':'enc_otp-sa-dsaWithSHA1'(T,V,O) end;
...
getdec_internal_object_set_argument_9(Id) when Id =:= {1,2,840,10040,4,3} ->
   fun(T,V,O) -> 'OTP-PKIX':'dec_otp-sa-dsaWithSHA1'(T,V,O) end;

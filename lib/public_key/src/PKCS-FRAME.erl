...
'enc_PBKDF2-params'/2,
enc_EncryptedData/2,
enc_EncryptionAlgorithmIdentifier/2,
enc_EncryptedPrivateKeyInfo/2,
enc_Attributes/2,
enc_PublicKey/2,
enc_PrivateKey/2,
enc_PrivateKeyAlgorithmIdentifier/2,
enc_Version/2,
enc_PrivateKeyInfo/2,
enc_OneAsymmetricKey/2,
enc_AsymmetricKeyPackage/2
]).
...
'dec_PBKDF2-params'/2,
dec_EncryptedData/2,
dec_EncryptionAlgorithmIdentifier/2,
dec_EncryptedPrivateKeyInfo/2,
dec_Attributes/2,
dec_PublicKey/2,
dec_PrivateKey/2,
dec_PrivateKeyAlgorithmIdentifier/2,
dec_Version/2,
dec_PrivateKeyInfo/2,
dec_OneAsymmetricKey/2,
dec_AsymmetricKeyPackage/2
]).

-export([
'enc_ct-asymmetric-key-package'/3
]).

-export([
'dec_ct-asymmetric-key-package'/3
]).
...
getenc_OneAsymmetricKeyAttributes/1,
getenc_ContentSet/1,
...
getdec_OneAsymmetricKeyAttributes/1,
getdec_ContentSet/1,
...
encode_disp('EncryptionAlgorithmIdentifier', Data) -> enc_EncryptionAlgorithmIdentifier(Data);
...
encode_disp('PrivateKeyAlgorithmIdentifier', Data) -> enc_PrivateKeyAlgorithmIdentifier(Data);
...
encode_disp('AsymmetricKeyPackage', Data) -> enc_AsymmetricKeyPackage(Data);
...
decode_disp('EncryptionAlgorithmIdentifier', Data) -> dec_EncryptionAlgorithmIdentifier(Data);
...
decode_disp('PrivateKeyAlgorithmIdentifier', Data) -> dec_PrivateKeyAlgorithmIdentifier(Data);
...
decode_disp('AsymmetricKeyPackage', Data) -> dec_AsymmetricKeyPackage(Data);
...
Term2 = 
   case Tmpterm1 of
      ...
      _ ->
         try DecObjalgorithmTerm1('Type', Tmpterm1, [])
         catch
...
%%================================
enc_EncryptionAlgorithmIdentifier(Val) ->
    enc_EncryptionAlgorithmIdentifier(Val, [<<48>>]).

enc_EncryptionAlgorithmIdentifier(Val, TagIn) ->
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
...
dec_EncryptionAlgorithmIdentifier(Tlv) ->
   dec_EncryptionAlgorithmIdentifier(Tlv, [16]).

dec_EncryptionAlgorithmIdentifier(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_8'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
Res1 = {'EncryptionAlgorithmIdentifier',Term1,Term2},
Res1.
...
%%-------------------------------------------------
%% attribute encryptionAlgorithm(1)   External PKCS-FRAME:EncryptionAlgorithmIdentifier
%%-------------------------------------------------
   {EncBytes1,EncLen1} = 'enc_EncryptionAlgorithmIdentifier'(Cindex1, [<<48>>]),
...
%%-------------------------------------------------
[V1|Tlv2] = Tlv1, 
Term1 = 'dec_EncryptionAlgorithmIdentifier'(V1, [16]),
...
'enc_Attributes_components'([H|T],AccBytes, AccLen) ->
   {EncBytes,EncLen} = 'enc_Attributes_Attribute'(H, [<<48>>]),
...
%%================================
enc_Attributes_Attribute(Val, TagIn) ->
   {_,Cindex1,Cindex2} = Val,
ObjattrType = 
...
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_Attributes_Attribute_attrValues'(Cindex2, [<<49>>], ObjattrType),
...
%%================================
%%  Attributes_Attribute_attrValues
%%================================
enc_Attributes_Attribute_attrValues(Val, TagIn, ObjFun) ->
      {EncBytes,EncLen} = 'enc_Attributes_Attribute_attrValues_components'(Val, ObjFun,[],0),
   encode_tags(TagIn, EncBytes, EncLen).

'enc_Attributes_Attribute_attrValues_components'([], _, AccBytes, AccLen) -> 
   {dynamicsort_SETOF(AccBytes),AccLen};

'enc_Attributes_Attribute_attrValues_components'([H|T], ObjFun,AccBytes, AccLen) ->
   {TmpBytes,_} = ObjFun('Type', H, []),
   {EncBytes,EncLen} = encode_open_type(TmpBytes, [])
,
   'enc_Attributes_Attribute_attrValues_components'(T, ObjFun,[EncBytes|AccBytes], AccLen + EncLen).
...
dec_Attributes(Tlv, TagIn) ->
   ...
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
['dec_Attributes_Attribute'(V1, [16]) || V1 <- Tlv1].


'dec_Attributes_Attribute'(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
[V1|Tlv2] = Tlv1, 
Term1 = decode_object_identifier(V1, [6]),
ObjFun = 'PKCS-FRAME':'getdec_internal_object_set_argument_9'(Term1),

%%-------------------------------------------------
%% attribute attrValues(2) with type SET OF
%%-------------------------------------------------
[V2|Tlv3] = Tlv2, 
Term2 = 'dec_Attributes_Attribute_attrValues'(V2, [17], ObjFun),
...
Res1.
'dec_Attributes_Attribute_attrValues'(Tlv, TagIn, ObjFun) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
%%================================
enc_PrivateKeyAlgorithmIdentifier(Val) ->
    enc_PrivateKeyAlgorithmIdentifier(Val, [<<48>>]).

enc_PrivateKeyAlgorithmIdentifier(Val, TagIn) ->
{_,Cindex1,Cindex2} = Val,
Objalgorithm = 
   'PKCS-FRAME':'getenc_internal_object_set_argument_11'(                                   Cindex1),
...
dec_PrivateKeyAlgorithmIdentifier(Tlv) ->
   dec_PrivateKeyAlgorithmIdentifier(Tlv, [16]).

dec_PrivateKeyAlgorithmIdentifier(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
DecObjalgorithmTerm1 =
   'PKCS-FRAME':'getdec_internal_object_set_argument_11'(Term1),
Term2 = 
   case Tmpterm1 of
      asn1_NOVALUE ->asn1_NOVALUE;
      _ ->
...
Res1 = {'PrivateKeyAlgorithmIdentifier',Term1,Term2},
Res1.
...
encode_integer(Val, [{v1,0},{v2,1}], TagIn).
...
%% attribute version(1) with type INTEGER
%%-------------------------------------------------
   {EncBytes1,EncLen1} = encode_integer(Cindex1, [{v1,0},{v2,1}], [<<2>>]),

%%-------------------------------------------------
%% attribute privateKeyAlgorithm(2)   External PKCS-FRAME:PrivateKeyAlgorithmIdentifier
%%-------------------------------------------------
   {EncBytes2,EncLen2} = 'enc_PrivateKeyAlgorithmIdentifier'(Cindex2, [<<48>>]),
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2, 
Term2 = 'dec_PrivateKeyAlgorithmIdentifier'(V2, [16]),
...
%%================================
enc_AsymmetricKeyPackage(Val) ->
    enc_AsymmetricKeyPackage(Val, [<<48>>]).

enc_AsymmetricKeyPackage(Val, TagIn) ->
   {EncBytes,EncLen} = 'enc_AsymmetricKeyPackage_components'(Val,[],0),
   encode_tags(TagIn, EncBytes, EncLen).

'enc_AsymmetricKeyPackage_components'([], AccBytes, AccLen) -> 
   {lists:reverse(AccBytes),AccLen};

'enc_AsymmetricKeyPackage_components'([H|T],AccBytes, AccLen) ->
   {EncBytes,EncLen} = 'enc_OneAsymmetricKey'(H, [<<48>>]),
   'enc_AsymmetricKeyPackage_components'(T,[EncBytes|AccBytes], AccLen + EncLen).



dec_AsymmetricKeyPackage(Tlv) ->
   dec_AsymmetricKeyPackage(Tlv, [16]).

dec_AsymmetricKeyPackage(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
['dec_OneAsymmetricKey'(V1, [16]) || V1 <- Tlv1].
...
%%================================
'enc_ct-asymmetric-key-package'('Type', Val, _RestPrimFieldName) ->
   enc_AsymmetricKeyPackage(Val, [<<48>>]).


'dec_ct-asymmetric-key-package'('Type', Bytes,_) ->
...
%%================================
getenc_OneAsymmetricKeyAttributes(_) ->
  fun(_, Val, _RestPrimFieldName) ->
    case Val of
      {asn1_OPENTYPE,Bin} when is_binary(Bin) ->
        {Bin,byte_size(Bin)}
...
getdec_OneAsymmetricKeyAttributes(_) ->
  fun(_,Bytes, _RestPrimFieldName) ->
    case Bytes of
      Bin when is_binary(Bin) -> 
        {asn1_OPENTYPE,Bin};
...
%%  ContentSet
%%================================
getenc_ContentSet(Id) when Id =:= {2,16,840,1,101,2,1,2,78,5} ->
    fun 'enc_ct-asymmetric-key-package'/3;
getenc_ContentSet(_) ->
  fun(_, Val, _RestPrimFieldName) ->
    case Val of
      {asn1_OPENTYPE,Bin} when is_binary(Bin) ->
...
getdec_ContentSet(Id) when Id =:= {2,16,840,1,101,2,1,2,78,5} ->
    fun 'dec_ct-asymmetric-key-package'/3;
getdec_ContentSet(_) ->
  fun(_,Bytes, _RestPrimFieldName) ->
    case Bytes of
      Bin when is_binary(Bin) -> 
